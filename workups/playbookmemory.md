```markdown
# SilentStacks Mandatory State Extraction (v2.1) — COMPLETE
...
|-------------------|----------------------|-------|
| ≤65% | Full canonical compliance | Stable, no degradation |
| 75% | Minor lag, canon enforcement intact | Slight slower gating |
| 80% | Increased latency | Still stable outputs |
| 85% | Recurrent failures appear | P0 logging, TOC misses, flush timing |
| 90% | Severe degradation | High risk of catastrophic gate bypass |
| ≥95% | Unstable, unrecoverable | Requires emergency flush |

---

# ✅ END OF COMPLETE STATE EXTRACTION
```
